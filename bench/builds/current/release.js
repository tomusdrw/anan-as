async function instantiate(module, imports = {}) {
  ...
  const adaptedExports = Object.setPrototypeOf({
    ...
    wrapAsProgram(bytecode) {
      ...
      bytecode = __lowerTypedArray(Uint8Array, 11, 0, bytecode) || __notnull();
    ...
    resetGenericWithMemory(program, flatRegisters, pageMap, chunks, initialGas, hasMetadata) {
      ...
      pageMap = __retain(__lowerTypedArray(Uint8Array, 11, 0, pageMap) || __notnull());
      chunks = __lowerTypedArray(Uint8Array, 11, 0, chunks) || __notnull();
      initialGas = initialGas || 0n;
      hasMetadata = hasMetadata ? 1 : 0;
      try {
        exports.__setArgumentsLength(arguments.length);
    ...
    getGasCosts(input, kind, withMetadata) {
      ...
      return __liftArray(pointer => __liftRecord52(__getU32(pointer)), 2, exports.getGasCosts(input, kind, withMetadata) >>> 0);
    },
    ...
    prepareProgram(kind, hasMetadata, program, initialRegisters, initialPageMap, initialMemory, args, preallocateMemoryPages) {
      ...
      program = __retain(__lowerArray(__setU8, 6, 0, program) || __notnull());
      initialRegisters = __retain(__lowerArray(__setU64, 54, 3, initialRegisters) || __notnull());
      initialPageMap = __retain(__lowerArray((pointer, value) => { __setU32(pointer, __lowerRecord48(value) || __notnull()); }, 49, 2, initialPageMap) || __notnull());
      initialMemory = __retain(__lowerArray((pointer, value) => { __setU32(pointer, __lowerRecord50(value) || __notnull()); }, 51, 2, initialMemory) || __notnull());
      args = __lowerArray(__setU8, 6, 0, args) || __notnull();
      try {
    ...
    runProgram(program, initialGas, programCounter, logs, useSbrkGas, dumpMemory) {
      ...
      exports.__setArgumentsLength(arguments.length);
      return __liftRecord57(exports.runProgram(program, initialGas, programCounter, logs, useSbrkGas, dumpMemory) >>> 0);
    },
    ...
    pvmDestroy(pvmId) {
      ...
      return __liftRecord57(exports.pvmDestroy(pvmId) >>> 0);
    },
    pvmSetRegisters(pvmId, registers) {
      // assembly/api-utils/pvmSetRegisters(u32, ~lib/array/Array<u64>) => void
      registers = __lowerArray(__setU64, 54, 3, registers) || __notnull();
    ...
    pvmResume(pvmId, gas, pc, logs) {
      ...
      logs = logs ? 1 : 0;
      exports.__setArgumentsLength(arguments.length);
      return __liftRecord63(exports.pvmResume(pvmId, gas, pc, logs) >>> 0);
    },
  }, exports);
  ...
  function __lowerRecord50(value) {
    ...
    // Hint: Opt-out from lowering as a record by providing an empty constructor
    if (value == null) return 0;
    const pointer = exports.__pin(exports.__new(8, 50));
    __setU32(pointer + 0, value.address);
  ...
  function __liftRecord57(pointer) {
    ...
    return {
      ...
      memory: __liftArray(pointer => __liftRecord50(__getU32(pointer)), 2, __getU32(pointer + 32)),
    };
  }
  function __liftRecord63(pointer) {
