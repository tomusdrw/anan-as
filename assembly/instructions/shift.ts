...
// SHLO_L_IMM_32
export const shlo_l_imm_32: InstructionRun = (args, registers) => {
...
// SHLO_R_IMM_32
export const shlo_r_imm_32: InstructionRun = (args, registers) => {
  const shift = u32(args.c % MAX_SHIFT_32);
  const value = u32(registers[reg(args.a)]);
  registers[reg(args.b)] = u32SignExtend(value >>> shift);
  return ok();
...
// SHAR_R_IMM_32
export const shar_r_imm_32: InstructionRun = (args, registers) => {
  const shift = u32(args.c % MAX_SHIFT_32);
...
// SHLO_L_IMM_ALT_32
export const shlo_l_imm_alt_32: InstructionRun = (args, registers) => {
...
// SHLO_R_IMM_ALT_32
export const shlo_r_imm_alt_32: InstructionRun = (args, registers) => {
  const shift = u32(registers[reg(args.a)] % MAX_SHIFT_32);
  registers[reg(args.b)] = u32SignExtend(args.c >>> shift);
  return ok();
};
...
// SHAR_R_IMM_ALT_32
export const shar_r_imm_alt_32: InstructionRun = (args, registers) => {
  const shift = u32(registers[reg(args.a)] % MAX_SHIFT_32);
...
// SHLO_L_IMM
export const shlo_l_imm: InstructionRun = (args, registers) => {
...
// SHLO_R_IMM
export const shlo_r_imm: InstructionRun = (args, registers) => {
  const shift = u32(args.c % MAX_SHIFT_64);
  registers[reg(args.b)] = registers[reg(args.a)] >>> shift;
  return ok();
};
...
// SHAR_R_IMM
export const shar_r_imm: InstructionRun = (args, registers) => {
  const shift = u32(args.c % MAX_SHIFT_64);
...
// SHLO_L_IMM_ALT
export const shlo_l_imm_alt: InstructionRun = (args, registers) => {
...
// SHLO_R_IMM_ALT
export const shlo_r_imm_alt: InstructionRun = (args, registers) => {
  const shift = u32(registers[reg(args.a)] % MAX_SHIFT_64);
  registers[reg(args.b)] = u32SignExtend(args.c) >>> shift;
  return ok();
};
...
// SHAR_R_IMM_ALT
export const shar_r_imm_alt: InstructionRun = (args, registers) => {
  const shift = u32(registers[reg(args.a)] % MAX_SHIFT_64);
...
// SHLO_L_32
export const shlo_l_32: InstructionRun = (args, registers) => {
  const shift = u32(registers[reg(args.a)] % MAX_SHIFT_32);
...
// SHLO_R_32
export const shlo_r_32: InstructionRun = (args, registers) => {
  const shift = u32(registers[reg(args.a)] % MAX_SHIFT_32);
  const value = u32(registers[reg(args.b)]);
  registers[reg(args.c)] = u32SignExtend(value >>> shift);
  return ok();
...
// SHAR_R_32
export const shar_r_32: InstructionRun = (args, registers) => {
  const shift = u32(registers[reg(args.a)] % MAX_SHIFT_32);
...
// SHLO_L
export const shlo_l: InstructionRun = (args, registers) => {
  const shift = u32(registers[reg(args.a)] % MAX_SHIFT_64);
...
// SHLO_R
export const shlo_r: InstructionRun = (args, registers) => {
  const shift = u32(registers[reg(args.a)] % MAX_SHIFT_64);
  registers[reg(args.c)] = registers[reg(args.b)] >>> shift;
  return ok();
};
...
// SHAR_R
export const shar_r: InstructionRun = (args, registers) => {
  const shift = u32(registers[reg(args.a)] % MAX_SHIFT_64);
